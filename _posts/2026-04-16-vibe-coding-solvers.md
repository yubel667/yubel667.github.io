...
结果是灾难性的。LLM 对复杂空间约束的理解漏洞百出，我花了大量时间去修补它理解错误的逻辑，至今也没有搞明白有些逻辑到底在写什么，一重构就挂。
...
![Asteroid Escape Solution](https://raw.githubusercontent.com/yubel667/asteroid-escape-solver/master/solutions/60.webp)
